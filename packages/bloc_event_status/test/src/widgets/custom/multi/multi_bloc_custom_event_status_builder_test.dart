  ...
  group('MultiBlocCustomEventStatusBuilder', () {
        ...
        MaterialApp(
          home: Scaffold(
            body: BlocProvider.value(
              value: testBloc,
              child: MultiBlocCustomEventStatusBuilder<TestBloc, TestEvent,
                  TestStatus>(
                builder: testBuilder,
              ),
            ),
    ...
    testWidgets('updates subscription and rebuilds when bloc instance changes',
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: MultiBlocCustomEventStatusBuilder<TestBloc, TestEvent,
                TestStatus>(
              bloc: blocA,
              builder: testBuilder,
            ),
    ...
    testWidgets('respects filter on initial build (initState)', (tester) async {
      ...
      // Should be None/None because the last event (EventA) is filtered out
      expect(find.text('Event: None, Status: None'), findsOneWidget);
    });
    ...
    testWidgets('respects filter when switching blocs (didUpdateWidget)',
      ...
      // testBloc2 has an event that will be filtered out
