...
void main() {
  group('MultiBlocBuilderWithEventStatus', () {
    ...
    Widget testBuilder(
      ...
      return Text(
        'Event: $eventDesc, Status: $statusString, State: $state',
      );
    }
        ...
        MaterialApp(
          home: Scaffold(
            body: BlocProvider.value(
              value: testBloc,
              child: MultiBlocBuilderWithEventStatus<TestBloc, TestEvent, int>(
                builder: testBuilder,
              ),
            ),
          ),
    ...
    testWidgets('updates subscription and rebuilds when bloc instance changes',
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: MultiBlocBuilderWithEventStatus<TestBloc, TestEvent, int>(
              bloc: blocA,
              builder: testBuilder,
            ),
          ),
